    ...
    return(
        <div className='basic-plan-pop-up'>
            <div className='parent-div shadow-1'>
                ...
                <button className="btn-nexus btn-golden mt-2" onClick={() => handlePlanSelection()}>Go to {plan.insurer_name}{loader ? <i className="ms-1 fas fa-circle-notch fa-spin"></i>:''}</button>
            </div> 
        </div>
    )
}
