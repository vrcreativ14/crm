        ...
        for qp in quoted_plans:
            if for_quote_form == True:
                ...
                plan_data = {
                    ...
                    "network_list_inpatient":qp.plan.tpa.network_list_inpatient.url if qp.plan.tpa.network_list_inpatient else '',
                    "network_list_outpatient":qp.plan.tpa.network_list_outpatient.url if qp.plan.tpa.network_list_outpatient else '',
