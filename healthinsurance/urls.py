...
urlpatterns = [
    ...
    # path("deals/<int:pk>/$", DealDetails.as_view(), name="update-deal-field"),        
    ...
    path("policies/<int:pk>/json/", PolicyJsonView.as_view(), name="policy-json"),
    ...
    path("policy/add", csrf_exempt(PolicyView.as_view()), name="new-policy"),
