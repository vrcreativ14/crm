            ...
            if stage_number > 6:
                ...
                if policy:
                    policy_details = {
                        ...
                        "currency": deal.selected_plan.currency if deal and selected_plan else '',
...
class DealExportView(View):
    def get(self, request, *args, **kwargs):
        data = list()
        column_labels = [
            '#','Stage', 'Status','Primary Customer','Primary Customer Email','Primary Customer Phone','Primary Customer DOB','Insurer', 'Budget', 'Premium', 
            'No. of Members', 'Emirate', 'Selected Plan','User', 'Referrer',
            'Created On', 'Updated On']
        qs = filter_deals(user = request.user, filters = request.GET)
        counter = 1
        for deal in qs:
            customer = deal.customer
            ...
            data.append([
                ...
                customer.dob, insurer, deal.indicative_budget, total_premium, 
